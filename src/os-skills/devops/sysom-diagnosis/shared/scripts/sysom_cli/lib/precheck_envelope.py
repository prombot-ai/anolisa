...
def envelope_from_precheck_result(check_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        findings_ok = [
            ...
            },
            {
                ...
                "detail": (
                    ...
                    "失败时检查云助手与控制台诊断授权；见 shared/references/openapi-permission-guide.md。"
                ),
            },
        ]
    ...
    if needs_sysom_activation:
        ...
        next_steps = [
            {
                "tool": "Read",
                "args": "shared/references/openapi-permission-guide.md",
        ...
        next_steps = [
            {
                "tool": "Read",
                "args": "shared/references/authentication.md（ECS RAM Role）",
                "reason": "角色授权与 CLI 配置细节",
            },
            {
                "tool": "Bash",
                "args": "cd <sysom-diagnosis 技能根> && ./shared/scripts/osops precheck",
                "reason": "修复后复验",
            },
        ]
        ...
        next_steps = [
            {
                "tool": "Read",
                "args": "shared/references/authentication.md（AccessKey）",
                "reason": "AK 配置与权限",
            },
            {
                "tool": "Bash",
                "args": "cd <sysom-diagnosis 技能根> && ./shared/scripts/osops configure",
        ...
        next_steps = [
            ...
            {
                "tool": "Read",
                "args": "shared/references/openapi-permission-guide.md（§4.1 ECS RAM Role）",
                "reason": "仅当用户选择 B：绑定角色与 EcsRamRole 分步说明",
            },
            {
                "tool": "Read",
                "args": "shared/references/authentication.md",
