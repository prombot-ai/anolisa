...
import type { SessionListItem, ListSessionsResult } from '@copilot-shell/core';
...
describe('SessionPicker', () => {
  ...
  describe('Branch Filtering', () => {
    it('should filter by branch when B is pressed', async () => {
      ...
      await wait(); // extra tick: ensure keypress handler re-registered with loaded sessions
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should select session on Enter', async () => {
      ...
      // Wait for session to load and render, then ensure keypress handler is registered
      await waitFor(() => {
        expect(lastFrame()).toContain('Select me');
      });
      await wait(); // extra tick: ensure keypress handler re-registered with loaded sessions
