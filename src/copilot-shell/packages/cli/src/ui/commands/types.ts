...
import type { Config, GitService, Logger } from '@copilot-shell/core';
import type {
...
/**
 * The return type for a command action that requests spawning an interactive
 * shell, temporarily suspending the TUI.
 */
export interface SpawnShellActionReturn {
  type: 'spawn_shell';
  /** The shell executable to spawn. Defaults to 'bash'. */
  shell?: string;
}
