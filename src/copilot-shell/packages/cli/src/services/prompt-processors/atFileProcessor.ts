...
import { flatMapTextParts, readPathFromWorkspace } from '@copilot-shell/core';
      ...
      for (const injection of injections) {
        ...
        try {
          ...
          if (fileContentParts.length === 0) {
            const uiMessage = `File '@{${pathStr}}' was ignored by .gitignore or .copilotignore and was not included in the prompt.`;
            context.ui.addItem(
