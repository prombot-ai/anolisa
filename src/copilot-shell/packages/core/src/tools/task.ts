...
tool: {
  "description": "Review the isPrime function",
  "prompt": "The isPrime function checks if a number is prime. Please review the code for correctness, efficiency, and best practices. Provide any suggestions for improvement.",
...
tool: {
  "description": "Respond to the user's greeting with a friendly joke",
  "prompt": "Please respond to the user's greeting with a friendly joke",
  "subagent_type": "greeting-responder"
}
</example>
`;
