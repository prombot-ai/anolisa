...
describe('QwenIgnoreParser', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(
      path.join(os.tmpdir(), 'copilotignore-test-'),
    );
  });
  ...
  describe('when .copilotignore exists', () => {
    beforeEach(async () => {
    ...
    it('should ignore files specified in .copilotignore', () => {
  ...
  describe('when .copilotignore does not exist', () => {
